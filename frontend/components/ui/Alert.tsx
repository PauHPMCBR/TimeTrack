...
const variantStyles: Record<AlertVariant, string> = {
    default:
        'bg-zinc-50 text-zinc-900 border-zinc-200 dark:bg-zinc-800/50 dark:text-zinc-100 dark:border-zinc-800',
    ...
    warning:
        'bg-yellow-50 text-yellow-800 border-yellow-200 dark:bg-yellow-900/20 dark:text-yellow-300 dark:border-yellow-900/30',
    destructive:
        'bg-red-50 text-red-800 border-red-200 dark:bg-red-900/20 dark:text-red-300 dark:border-red-900/30',
};
