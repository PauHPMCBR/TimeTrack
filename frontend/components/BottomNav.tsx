...
import { CheckCircle, History, CalendarDays, User, CalendarOff, LayoutDashboard } from "lucide-react";
...
export default function BottomNav() {
  ...
  if (isAdmin) {
    items.push({ href: "/admin", label: t("tabs.admin"), Icon: LayoutDashboard });
  }
