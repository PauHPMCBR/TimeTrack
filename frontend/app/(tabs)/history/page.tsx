...
import { useThemeFlavor } from '@/lib/useThemeFlavor';
...
export default function HistoryAndStatsPage() {
    ...
    const avgPerDayThisWeek = useMemo(() => {
        ...
        const days = Math.max(
            ...
            Math.min(
                5,
                Math.floor((today.getTime() - wStart.getTime()) / 86_400_000) +
                    1
            )
        );
        ...
        <section className="space-y-6">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
                ...
                <Card className="p-4">
                    ...
                    <div className="mt-1 text-2xl font-semibold">
                        {fmtHM(avgPerDayThisWeek)}
                    </div>
                </Card>
                <Card className="p-4">
                    <div className="text-sm text-zinc-500">
                        {t('history.daysWithCheckins')}
                    </div>
                    <div className="mt-1 text-2xl font-semibold">
                        {perDay.length}
                    </div>
