...
import type {
    ...
    IllegalAction,
    IncorrectParameter,
    IncorrectParameterReason,
} from 'shared/src/types/response-errors';
...
export function responseErrorEntryNotFound(
    res: NextApiResponse,
    entryName?: string
) {
...
export function responseErrorAccountBlocked(
    res: NextApiResponse,
...
export function responseErrorIncorrectParameter(
    ...
    reasons?: IncorrectParameterReason[]
) {
...
export function responseErrorMissingParameter(
    res: NextApiResponse,
    parameter?: IncorrectParameter
) {
...
export function responseErrorIllegalAction(
    res: NextApiResponse,
